...
Per i solidi a forma di parallelepipedo abbiamo usato la seguente formula per calcolare il volume a partire dalle misure dirette riportate in tabella~\ref{tab:dir_cilindri}.
\begin{equation}
    V_c = \ldots
\end{equation}
...
\verb|Python|. Considerando che la teoria prevede una dipendenza lineare tra massa e volume, abbiamo utilizzato come modello la funzione:
\begin{equation}
    f(x) = \alpha x + \beta
\end{equation}
